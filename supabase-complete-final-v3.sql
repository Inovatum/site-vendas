-- ============================================================================
-- SETUP COMPLETO DO BANCO DE DADOS - SUPABASE (VERSÃO FINAL v3)
-- ============================================================================
...
-- Políticas para categories (leitura e escrita públicas)
...
INSERT INTO store_customization (
  ...
  '#ffffff',  -- Fundo do carrinho branco
  '#f8fafc',  -- Fundo do menu cinza muito claro
...
SELECT 'Tabelas criadas: categories, products, store_settings, store_customization' as info;
SELECT 'Funcionalidades: Sistema de categorias gerenciável, Logo arredondada, Cores completas incluindo carrinho/menu' as features;
...
-- ✅ Sistema de categorias gerenciável pelo admin (NOVO)
--    - Criar, editar, ativar/desativar e excluir categorias
--    - Ordem de exibição configurável
--    - Produtos usam categorias do banco
...
--    - Cores do header e footer
--    - Cores do carrinho e menu (NOVO)
-- ✅ Logo configurável melhorado:
--    - Upload de imagem com logo ARREDONDADA (NOVO)
--    - 3 tamanhos: pequeno (32px), médio (40px), grande (48px)
--    - Opção de mostrar/ocultar logo completamente (CORRIGIDO)
--    - Fallback para inicial da loja quando sem logo
...
-- ✅ Prevenção de flash de cores padrão (loading até carregar do banco)
