...
export function debugSupabaseError(error: any, context = "") {
...
// Função para formatar erros (se você tiver um arquivo errorUtils.ts, pode mover para lá)
...
export interface StoreSettings {
  ...
  browser_tab_title: string // Adicionado
  favicon_url: string | null // Adicionado
  created_at?: string
  updated_at?: string
}
